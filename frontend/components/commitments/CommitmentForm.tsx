      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="flex gap-2 mb-2">
              {["social", "money"].map((type) => (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setFormData((prev: any) => ({ ...prev, stake_type: type }))
                  }
                  className={`flex-1 p-2 rounded-lg border-2 border-black font-bold text-sm transition-all ${
                    formData.stake_type === type
                      ? "bg-black text-white"
            ...
            {formData.stake_type === "social" && (
              <p className="text-sm text-gray-600 mt-2">
                Your commitment will be shared with your accountability
                partners.
              </p>
            )}
          </div>
          ...
          <div>
            ...
            >
              <option value="self_verification">
                Self Verification (Honor System)
              </option>
