git add .
git commit -m "Merge dump into main"
...
<<<<<<< HEAD
      className={cn(
        "sticky inset-x-0 top-0 z-40 w-full bg-[#fef6e4] py-4",
        className
      )}
=======
...
<<<<<<< HEAD
        ...
        visible
          ? "bg-black dark:bg-neutral-950/80"
          : "bg-black dark:bg-neutral-950/95",
=======
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
<<<<<<< HEAD
              className="absolute inset-0 h-full w-full rounded-full dark:bg-neutral-800 bg-neutral-800"
=======
...
<<<<<<< HEAD
    secondary: "bg-transparent shadow-none dark:text-white text-white",
=======
